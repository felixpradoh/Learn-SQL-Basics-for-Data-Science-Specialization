...
--             In this step join the sub table from the previous exercise to the dates rollup table so we can get a 
--             row for every date. Check that the join works by just running a “select *” query 
